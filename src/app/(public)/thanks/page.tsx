    ...
    return (
        <div className="min-h-screen bg-bg-alt flex items-center justify-center p-4">
            <div className="max-w-md w-full bg-white p-8 rounded-3xl shadow-lg border border-gray-100 text-center space-y-6">
                ...
                <div className="bg-primary-light/50 border border-primary-light rounded-xl p-4 text-sm text-primary-hover font-medium">
                    Il nostro team valuterà il tuo profilo entro 24-48 ore. Riceverai un aggiornamento tramite email o WhatsApp.
                </div>
                <div className="pt-6">
