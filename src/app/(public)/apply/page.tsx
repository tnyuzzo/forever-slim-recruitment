...
export default function ApplyPage() {
    ...
    // Track form start
    useEffect(() => {
        posthog?.capture('form_started', { funnel_type: 'donna' })
    ...
    const handleAudioChange = async (e: React.ChangeEvent<HTMLInputElement>) => {
        ...
        if (file) {
            ...
            setAudioFile(file)
            posthog?.capture('audio_upload_selected', { file_type: file.type, file_size_mb: +(file.size / 1024 / 1024).toFixed(1), funnel_type: 'donna' })
    ...
    const onSubmit: SubmitHandler<FieldValues> = async (_stepData) => {
        ...
        try {
            ...
            console.error(err)
            posthog?.capture('form_submit_exception', { error: err instanceof Error ? err.message : 'unknown', funnel_type: 'donna' })
                    ...
                    <div className="space-y-6">
                        ...
                        <div className="grid md:grid-cols-2 gap-6">
                            <div className="space-y-2">
                                ...
                                })} className="w-full border border-gray-300 rounded-xl px-4 py-3 bg-white focus:outline-none focus:ring-2 focus:ring-primary-main appearance-none">
                                    {COUNTRIES.map(c => (
                    ...
                    <div className="space-y-6">
                        <div className="grid md:grid-cols-2 gap-6">
                            <div className="space-y-2">
                                ...
                                <select {...register("nationality")} className="w-full border border-gray-300 rounded-xl px-4 py-3 bg-white focus:outline-none focus:ring-2 focus:ring-primary-main appearance-none">
                                    {NATIONALITIES.map(n => (
                        ...
                        <div className="border-t border-gray-200 pt-8">
                            <div className="flex flex-col items-center space-y-4">
                                ...
                                <div className="w-full max-w-md mt-4">
                                    ...
                                    <button type="button" onClick={() => audioInputRef.current?.click()} className="w-full flex justify-center items-center px-4 py-6 bg-white border-2 border-dashed border-gray-300 rounded-2xl cursor-pointer hover:bg-gray-50 hover:border-primary-main transition-colors">
                ...
                <div className="mb-8 p-6 bg-white rounded-3xl shadow-sm border border-gray-100">
                    ...
                    <div>
                        ...
                        <form onSubmit={handleSubmit(onSubmit)} autoComplete="off" className="space-y-8">
                            ...
                            {/* key={step} forces React to recreate DOM nodes on step change,
