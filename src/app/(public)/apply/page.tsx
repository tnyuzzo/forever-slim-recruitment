                        ...
                        <div className="space-y-3">
                            ...
                            {photoPreview ? (
                                ...
                                <>
                                    ...
                                    <button type="button" onClick={() => photoInputRef.current?.click()} className="flex items-center justify-center gap-3 px-4 py-6 w-full bg-white border-2 border-dashed border-gray-300 rounded-2xl cursor-pointer hover:bg-gray-50 hover:border-primary-main transition-colors">
