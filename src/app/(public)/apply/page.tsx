                        ...
                        <div className="space-y-2">
                            ...
                            <div className="flex gap-2">
                                <select
                                    ...
                                    className="shrink-0 w-[130px] border border-gray-300 rounded-xl px-3 py-3 bg-white focus:outline-none focus:ring-2 focus:ring-primary-main appearance-none text-sm font-medium"
                                >
