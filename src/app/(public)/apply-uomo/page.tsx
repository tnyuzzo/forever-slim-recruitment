...
export default function ApplyPage() {
    ...
    const handlePhotoChange = async (e: React.ChangeEvent<HTMLInputElement>) => {
        ...
        try {
            ...
            posthog?.capture('photo_upload_selected', { file_type: compressed.type, file_size_mb: +(compressed.size / 1024 / 1024).toFixed(1), original_mb: +(file.size / 1024 / 1024).toFixed(1), funnel_type: 'uomo' })
            const reader = new FileReader()
            reader.onloadend = () => setPhotoPreview(reader.result as string)
            reader.readAsDataURL(compressed)
        } catch {
            posthog?.capture('photo_upload_rejected', { reason: 'compression_failed', file_type: file.type, funnel_type: 'uomo' })
    ...
    const onSubmit: SubmitHandler<FieldValues> = async (_stepData) => {
        ...
        try {
            ...
            if (!res.ok) {
                ...
                posthog?.capture('form_submit_error', { status: res.status, error: result?.error || 'unknown', details: result?.details || null, funnel_type: 'uomo' })
                        ...
                        <div className="space-y-2">
                            ...
                            <div className="flex gap-2">
                                <select
                                    ...
                                    className="shrink-0 w-[100px] border border-gray-300 rounded-xl px-2 py-3 bg-white focus:outline-none focus:ring-2 focus:ring-blue-600 text-sm font-medium"
                                >
                        ...
                        <div className="space-y-2">
                            ...
                            <div className="flex gap-2">
                                <select
                                    ...
                                    className="flex-1 border border-gray-300 rounded-xl px-3 py-3 bg-white focus:outline-none focus:ring-2 focus:ring-blue-600 appearance-none text-sm"
                                >
                                ...
                                <select
                                    ...
                                    className="flex-[1.4] border border-gray-300 rounded-xl px-3 py-3 bg-white focus:outline-none focus:ring-2 focus:ring-blue-600 appearance-none text-sm"
                                >
                ...
                return (
                    <div className="space-y-8">
                        ...
                        <div className="space-y-3">
                            ...
                            {photoCompressing ? (
                                <div className="flex items-center justify-center gap-3 px-4 py-6 w-full bg-gray-50 border-2 border-dashed border-blue-600 rounded-2xl">
                    ...
                    <div className="space-y-6">
                        ...
                        <div className="space-y-4">
                            ...
                            <label className="flex items-start gap-3 p-4 border border-gray-200 rounded-xl hover:bg-gray-50 cursor-pointer">
                                ...
                                <span className="text-text-main text-sm">Acconsento al trattamento dei miei dati personali ai fini del processo di selezione. Cliccando su Invia, accetto la <a href="/privacy" target="_blank" className="text-blue-600 underline hover:text-blue-500">Privacy Policy</a> e i <a href="/terms" target="_blank" className="text-blue-600 underline hover:text-blue-500">Termini &amp; Condizioni</a>.</span>
                            </label>
